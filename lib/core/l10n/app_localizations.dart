...
abstract class AppLocalizations {
  ...
  /// No description provided for @gameInProgressMessage.
  ///
  /// In en, this message translates to:
  /// **'A game is already in progress. Please finish or quit the current game first.'**
  String get gameInProgressMessage;

  /// No description provided for @gameModeAi.
  ///
  /// In en, this message translates to:
  /// **'vs AI'**
  String get gameModeAi;
  ...
  /// No description provided for @resumeGameMessage.
  ///
  /// In en, this message translates to:
